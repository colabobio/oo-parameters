...
output_folder <- file.path(main_folder, "output_fixedrho") 
if (!dir.exists(output_folder)) dir.create(output_folder)
cooking_folder <- file.path(main_folder, "output_fixedrho", "bake")
if (!dir.exists(cooking_folder)) dir.create(cooking_folder)
plotting_folder <- file.path(main_folder, "output_fixedrho", "plots")
...
free_param_names <- c("Beta0", "BetaCoeff1", "Time1", "Gamma")
...
perturb_sizes <- list(Beta0=0.02, BetaCoeff1=0.02, Time1=0.02, Gamma=0.02)
cool_frac <- 0.5
cool_type <- "geometric"

# Variables to use in the scatterplot matrix showing the result of the IF search
pair_vars <- ~loglik+Beta0+BetaCoeff1+Time1+Gamma
```
...
mcap_lambda <- c(Beta0=0.75, BetaCoeff1=0.75, Time1=0.75, Gamma=0.75)

mcap_ngrid <- c(Beta0=1000, BetaCoeff1=1000, Time1=1000, Gamma=1000)
```
