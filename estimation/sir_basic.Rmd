...
This notebook loads data from O2 simulations and applies IF from the POMP package to estimate epidemic parameters of a simple SIR model.
...
free_param_names <- c("Beta", "Gamma", "Rho")
...
fixed_param_names <- c("N", "S0", "I0", "R0")
fixed_param_values <- c(N=pop_size, S0=pop_size-inf0-rem0, I0=inf0, R0=rem0)
